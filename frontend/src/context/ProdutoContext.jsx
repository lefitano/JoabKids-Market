...
export function ProdutoProvider({children}){
    const [produtos, setProdutos] = useState( [
        ...
        { id: 2, referencia: "JK-002", nome: "Conjunto Casual",    preco: 59.90, categoria: "Masculino", imagem: ImagemMasculino2, tamanhos: ["4", "6", "8", "10", "12"],   cores: ["Preto", "Azul Marinho", "Cáqui"],  descricao: "Conjunto com camiseta e bermuda, perfeito para passeios e brincadeiras.", destaque: false },
        ...
        { id: 4, referencia: "JK-004", nome: "Conjunto Rosa",      preco: 54.90, categoria: "Feminino",  imagem: ImagemFeminino2,  tamanhos: ["4", "6", "8", "10", "12"],   cores: ["Rosa", "Branco", "Roxo"],          descricao: "Conjunto com blusa e calça, confortável e estiloso para o cotidiano.", destaque: false },
        ...
        { id: 6, referencia: "JK-006", nome: "Tênis Colorido",     preco: 69.90, categoria: "Calçados",  imagem: ImagemCalcado2,   tamanhos: ["26", "28", "30", "32", "34"], cores: ["Branco", "Preto", "Azul"],        descricao: "Tênis colorido com solado macio, ideal para brincar e se movimentar.", destaque: false },
    ])
